...
<footer style="background-color: #f5f5f5; padding: 50px 20px; margin-top: 100px;">
    <div style="max-width: 1200px; margin: 0 auto; display: flex; justify-content: space-between; flex-wrap: wrap; gap: 30px;">
        ...
        <div style="flex: 1 1 200px;">
            ...
            <ul style="list-style: none; padding: 0;">
                <li style="margin-bottom: 10px;"><a href="index.php?page=payment" style="text-decoration: none; color: #666;">Tùy chọn thanh toán</a></li>
                <li style="margin-bottom: 10px;"><a href="index.php?page=home" style="text-decoration: none; color: #666;">Trả Hàng</a></li>
                <li style="margin-bottom: 10px;"><a href="index.php?page=privacy" style="text-decoration: none; color: #666;">Chính sách quyền riêng tư</a></li>
            </ul>
        </div>
